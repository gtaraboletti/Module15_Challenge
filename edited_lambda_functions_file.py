    ...
    if age is not None:
        ...
        if age <= 0: 
            return build_validation_result(
                False, 
                "age",
                "Your age should be a number greater than 0."
        ...
        if age >= 65: 
            return build_validation_result(
                False, 
                "age", 
                "You are past the retirement age."
                "You will need a different type of portfolio.",
            )
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False, 
                "investmentAmount",
                "You will need to invest at least $5000 USD."
        ...
        if risk_level == "None" or "none": 
            return close(
                ...
                { 
                    ...
                    "content": "Thank you for your information. You should  invest in 100%  bonds (AGG), 0% equities (SPY)." 
            ...
            return close(
                ...
                { 
                    "contentType": "PlainText",
                    "content": "Thank you for your information. You should  invest in 60%  bonds (AGG), 40% equities (SPY)." 
            ...
            return close(
                ...
                { 
                    "contentType": "PlainText",
                    "content": "Thank you for your information. You should  invest in 40%  bonds (AGG), 60% equities (SPY)." 
            ...
            return close(
                ...
                { 
                    "contentType": "PlainText",
                    "content": "Thank you for your information. You should  invest in 20%  bonds (AGG), 80% equities (SPY)." 
